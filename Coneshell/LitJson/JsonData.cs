...
namespace LitJson
{
	public class JsonData : IJsonWrapper, IList, ICollection, IEnumerable, IOrderedDictionary, IDictionary, IEquatable<JsonData>
	{
		...
		public int ToInt()
		{
			return type switch
			{
				JsonType.Int => inst_int, 
				JsonType.Double => Convert.ToInt32(inst_double), 
				JsonType.Long => Convert.ToInt32(inst_long), 
				JsonType.String => Convert.ToInt32(inst_string), 
				JsonType.Boolean => Convert.ToInt32(inst_boolean), 
				_ => 0, 
			};
		}
		...
		public long ToLong()
		{
			return type switch
			{
				JsonType.Int => Convert.ToInt64(inst_int), 
				JsonType.Double => Convert.ToInt64(inst_double), 
				JsonType.Long => inst_long, 
				JsonType.String => Convert.ToInt64(inst_string), 
				JsonType.Boolean => Convert.ToInt64(inst_boolean), 
				_ => 0L, 
			};
		}
		...
		public double ToDouble()
		{
			return type switch
			{
				JsonType.Int => Convert.ToDouble(inst_int), 
				JsonType.Double => inst_double, 
				JsonType.Long => Convert.ToDouble(inst_long), 
				JsonType.String => Convert.ToDouble(inst_string), 
				JsonType.Boolean => Convert.ToDouble(inst_boolean), 
				_ => 0.0, 
			};
		}
		...
		public bool ToBoolean()
		{
			return type switch
			{
				JsonType.Int => Convert.ToBoolean(inst_int), 
				JsonType.Double => Convert.ToBoolean(inst_double), 
				JsonType.Long => Convert.ToBoolean(inst_long), 
				JsonType.String => Convert.ToBoolean(inst_string), 
				JsonType.Boolean => inst_boolean, 
				_ => false, 
			};
		}
	}
